let juego;
//Las de abajo sacar y poner donde corresponden!!!!
let dastan, traitor;
let secuaces = [];
let combustibles = [];
//Estas si se pueden dejar: !!!!!
let song;
//O Meter dentro de constructor load image dentro de cada clase 
...
function keyPressed() {
   dastan.handleKeyPressed(); // Delegar el manejo a la clase Dastan
 ...
 if (key === 's' || key === 'S') {
  ...
  function keyReleased() {
   dastan.handleKeyReleased(); // Delegar el manejo a la clase Dastan
}
