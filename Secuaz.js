...
// Método que mueve al secuaz. El secuaz se mueve verticalmente en función de su velocidad.
  move() {
...
// Si el contador de frames es múltiplo de 90 (es decir, cada 90 cuadros), dispara un proyectil.
    if (frameCount % 90 === 0) {
// Crea un nuevo proyectil en la posición (this.x, this.y) del secuaz con una velocidad de 5.
      let projectile = new Projectile(this.x, this.y, 5);
// Añade el proyectil a la lista (Arreglo) de proyectiles de los secuaces (secuazProjectiles).
