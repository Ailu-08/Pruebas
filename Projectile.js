class Projectile {
// Constructor de la clase 'Projectile'. Se ejecuta al crear una nueva instancia.
  ...
  move() {   // Método para mover el proyectil hacia abajo (en el eje Y).
...
// Calcula la distancia entre el proyectil (this.x, this.y) y el objetivo (target.x, target.y)
