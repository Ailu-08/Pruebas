// Clase que maneja el objeto 'Combustible', que podría ser un ítem en el juego
class Combustible {
  // El constructor se llama cuando se crea una nueva instancia de la clase 'Combustible'
  constructor(x, y) {  // Recibe las coordenadas 'x' y 'y' para colocar el combustible en una ubicación específica
// Asigna las coordenadas 'x' y 'y' a las propiedades de la instancia de la clase (Coordenadas en el espacio)
    this.x = x;
    this.y = y;
  }
  
  // Método para mostrar el combustible en el canvas (pantalla del juego)
  display() {
